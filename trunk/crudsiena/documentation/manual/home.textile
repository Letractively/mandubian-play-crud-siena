...
The module for Play! framework provides javascript client templating based on "Google Closure Templating":http://code.google.com/closure/templates/ . 

p(note). **Note:** Other tools from Google Closure may be added later. So don't hesitate to ask if you need something about them. 

Any SOY template files in your app/** directory is automatically compiled into JS at runtime by the Play! enhancing mechanism.
